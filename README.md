...
|:------------------------------------------------------------------------------------------ |:---------:|:---------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------:|
| Learning Conditional Attributes for Compositional Zero-Shot Learning | CVPR 2023 | MIT-States & UT-Zappos & C-GQA | - |   [CODE](https://github.com/wqshmzh/CANet-CZSL)   |
| Learning Attention as Disentangler for Compositional Zero-shot Learning | CVPR 2023 | Clothing16K & UT-Zappos & C-GQA & VAW-CZSL | [PDF](https://arxiv.org/abs/2303.15111) |   [CODE](https://github.com/haoosz/ade-czsl)   |
...
| Hierarchical Prompt Learning for Compositional Zero-Shot Recognition  | IJCAI 2023 | - | - |   -   |
